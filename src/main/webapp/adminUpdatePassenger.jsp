...
<%  User auth = (User )request.getSession().getAttribute("auth");
  ...
  Integer passengerId = (Integer) request.getSession().getAttribute("passengerId");
...
<div class="container mx-auto">
  ...
  <div class="row">
    ...
    <div class="col-md-offset-3 col-md-6 mx-auto ">
      ...
      <form class="form-horizontal" action="UpdatePassenger?id=<%=passengerId%>" method="post">
        ...
        <div class="input-group mb-3">
          <input type="text" value="<%=passenger.getName()%>" minlength="2" maxlength="30" class="form-control" placeholder="surname" aria-label="surname" name="name" required>

          <input type="text"  value="<%=passenger.getSurname()%>" minlength="2" maxlength="30" class="form-control" placeholder="surname" aria-label="surname"  name="surname" required>
        </div>
        ...
        <div class="input-group mb-3">
          <input type="text" value="<%=passenger.getPassport()%>" minlength="9" maxlength="9" class="form-control" placeholder="passport" aria-label="passport" name="passport" required>

        </div>

        <div class="input-group mb-3">
          <span class="input-group-text" id="basic-addon1">+375</span>
          <input type="text" value="<%=passenger.getPhoneNumber()%>" minlength="9" maxlength="9" class="form-control" placeholder="phoneNumber" aria-label="phoneNumber" name="phoneNumber" required>
        </div>

        <div class="input-group mb-3">
          <input type="text" value="<%=passenger.getEmail()%>" minlength="2" maxlength="30" class="form-control" placeholder="mail" aria-label="@" name="email" required>
        </div>
