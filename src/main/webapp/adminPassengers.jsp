...
<div class="container mx-auto">
  <form action="Passengers" method="POST">
    ...
    <div class="form-check form-check-inline">
      <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="byname">
      <label class="form-check-label" for="inlineRadio1">byname</label>
    </div>
...
<div class="container mx-auto">
  <div class="row">
    <form method="post">
      <button class="btn btn-primary" type="submit" formaction="adminAddPassengers.jsp" name="edit" >Добавить</button>
      <br>
      <br>
      <table class="table table-striped table-bordered">
        ...
        <c:forEach items="${Passengers}" var="passenger">
          <tr>
            ...
            <td>
              <button onclick="myFunction()"  class="btn btn-primary" type="submit" formaction="DeletePassenger?id=${passenger.getId()}" name="delete" >Удалить</button>
              <button class="btn btn-primary" type="submit" formaction="ToUpdatePassenger?id=${passenger.getId()}" name="edit" >Отредактировать</button>
            </td>
