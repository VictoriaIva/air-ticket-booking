...
<div class="container mx-auto">
    ...
    <div class="row">
        ...
        <div class="col-md-offset-3 col-md-6 mx-auto ">
            ...
            <form class="form-horizontal" action="UpdateUser?id=<%=userId%>" method="post">

                <div class="input-group mb-3">
                    <input type="text" value="<%=user.getLogin()%>" minlength="2" maxlength="30" class="form-control" placeholder="login" aria-label="login" name="login" required>

                </div>
                <div class="input-group mb-3">
                    <input type="text" value="<%=user.getPassword()%>" minlength="4" maxlength="6" class="form-control" placeholder="password" aria-label="password" name="password" required>
                </div>
