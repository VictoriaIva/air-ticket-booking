...
<div class="container mx-auto">
  ...
  <div class="row">
    ...
    <div class="col-md-offset-3 col-md-6 mx-auto ">
      ...
      <form class="form-horizontal" action="AddFlight" method="post">
        ...
        <div class="input-group mb-3">
          <input type="text"  minlength="2" maxlength="30" class="form-control" placeholder="destination" aria-label="destination" name="destination" required>
        </div>
        <span class="heading">departureDate</span>
        <div class="input-group mb-3">
          <span class="input-group-text" id="basic-addon2">year</span>
          <input type="number" min="2023" max="2024"  value="2023"  class="form-control" placeholder="YYYY" aria-label="DATE" name="dyear" required>
          <span class="input-group-text" id="basic-addon3">month</span>
          <input type="number"  min="01" max="12" value="08"  class="form-control" placeholder="MM" aria-label="DATE" name="dmonth" required>
          <span class="input-group-text" id="basic-addon4">day</span>
          <input type="number" min="1" max="31"  value="11"  class="form-control" placeholder="DD" aria-label="DATE" name="dday" required>
        </div>
        <span class="heading">arrivalDate</span>
        <div class="input-group mb-3">
          <span class="input-group-text" id="basic-addon5">year</span>
          <input type="number" min="2023" max="2024"  value="2023"  class="form-control" placeholder="YYYY" aria-label="DATE" name="ayear" required>
          <span class="input-group-text" id="basic-addon6">month</span>
          <input type="number"  min="01" max="12" value="08"  class="form-control" placeholder="MM" aria-label="DATE" name="amonth" required>
          <span class="input-group-text" id="basic-addon7">day</span>
          <input type="number" min="1" max="31"  value="11"  class="form-control" placeholder="DD" aria-label="DATE" name="aday" required>
        </div>

        <div class="input-group mb-3">
          <input type="number" min="1" minlength="2" maxlength="9" class="form-control" placeholder="price" aria-label="price" name="price" required>
        </div>
